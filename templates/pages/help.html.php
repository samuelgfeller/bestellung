...
<div class="homeContainer">
    <h1 class="title" style="text-align: left;">Anleitung</h1>
    <h2>Einloggen</h2>
    <p>
    ...
    <h2>Bestellung</h2>
    <p>
        Im Bestellfenster sind alle verfügbaren Artikel und der kg-Preis zu sehen. Zum Bestellen müssen folgende Felder
        ausgefüllt sein:
    </p>
    <h3>Anzahl Päckchen</h3>
    <p>
    ...
    <h2>Für ein anderes Datum Bestellen</h2>
    <p>
        Es gibt die Möglichkeit für andere Daten voraus zu bestellen. Z. B., wenn Sie sicher ein bestimmtes Fleisch zu
        Weihnachten möchten. Im Bestellfenster gibt es einen Knopf oben rechts, welcher alle Daten anzeigt.
        Es ist möglich, dass Sie aber ein Datum anklicken und keine Bestellartikel zur Verfügung stehen.
        Das heisst, dass Nicolas noch nicht die Artikel festgelegt hat. In diesem Fall können Sie ein kurzes
        <a class="helpLink" href="mailto:info@masesselin.ch">mail</a> schicken.
    </p>

    <h2>Verfügbares Gewicht + Bestellgewicht</h2>
    <p>
    ...
    <p>
        Wenn Sie Ihre Bestellung schon gemacht haben und später entscheiden etwas zu ändern, können Sie sich
        einfach wieder einloggen und auf Ihrer Bestellung Änderungen vornehmen. Anschliessend auf "Bestellen" drücken und Ihre alte
        Bestellung wird überschrieben.
        <br>
        Bitte Bestellungen bis einen Tag vor dem Verkaufsdatum abgeben. Nachher werden Bestellungen nicht mehr
            aufgenommen. Sie sind aber am Stand willkommen und können sich aus den Resten bedienen
    </p>
    <h2>Kontakt</h2>
    <p>
        Falls irgendwelche Fragen auftauchen, Sie ein Feedback geben möchten oder Fehler gefunden haben können Sie
        mir gerne schreiben oder mich anrufen.
        Wie Sie es wahrscheinlich schon mitbekommen haben, bin ich Samuel, der Sohn von Nicolas.
        Die Applikation ist noch sehr neu und daher könnten Fehler, Unklarheiten oder andere unvorhergesehene Sachen auftauchen.
        Falls dies der Fall sein sollte, melden Sie sich bitte bei mir. Ich hoffe zutiefst, dass alles gehen wird,
        Sie mit dem Programm zufrieden sind, es gut verstehen und bedienen können. <br> Herzliche Grüsse <br>Samuel <br>
        <br>E-Mail: <a class="helpLink" href="mailto:samuelgfeller@bluewin.ch">samuelgfeller@bluewin.ch</a><br>
        Tel. 076 566 22 65
    </p>
    <h3>Nicolas Barth</h3>
    <p>
        E-Mail: <a class="helpLink" href="mailto:info@masesselin.ch">info@masesselin.ch</a><br>
        Tel. 032 955 17 04
    </p>

    <h3 style="text-align: center;"><a href="">Zur Bestellung</a></h3>
    <br><br> <br>
</div>
